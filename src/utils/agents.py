"""
User agent management utilities for RivalSearchMCP.
Handles user agent generation and selection for web requests.
"""
...
def get_random_user_agent() -> str:
    ...
    return random.choice(get_enhanced_ua_list())
