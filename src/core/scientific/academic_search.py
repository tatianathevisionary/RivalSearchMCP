...
class AcademicSearch:
    ...
    async def search_semantic_scholar(self, query: str, limit: int = 20, **kwargs) -> List[Dict[str, Any]]:
        """Search Semantic Scholar."""
        return await self.academic_orchestrator.providers["semantic_scholar"].search(query, limit, **kwargs)
    ...
    async def search_combined_academic(self, query: str, sources: List[str] = None, max_results: int = 50, **kwargs) -> Dict[str, Any]:
        """Search across multiple academic sources."""
        return await self.academic_orchestrator.search_combined_academic(query, sources, max_results, **kwargs)
...
class DatasetDiscovery:
    ...
    async def search_kaggle_datasets(self, query: str, limit: int = 20, **kwargs) -> List[Dict[str, Any]]:
    ...
    async def search_combined_datasets(self, query: str, sources: List[str] = None, max_results: int = 50, **kwargs) -> Dict[str, Any]:
        """Search across multiple dataset sources."""
        return await self.orchestrator.search_combined_datasets(query, sources, max_results, **kwargs)